...
dispatch(fetchAllUsers())
    ...
    return (
        <div className="p-6 bg-gray-100 min-h-screen">
            <h2 className="text-3xl font-bold mb-8 text-center text-gray-800">All Customers</h2>
                        ...
                        {getAllUsers.length > 0 ? (
                            getAllUsers.map((customer) => (
                                <tr key={customer._id} className="border-b border-gray-200 hover:bg-gray-100">
                                    ...
                                    <td className="py-3 px-6 text-left">
                                        <span
                                            className={`py-1 px-3 rounded-full text-xs ${customer.verified ? 'bg-green-200 text-green-600' : 'bg-red-200 text-red-600'}`}>
                                        ...
                                        <div className="flex item-center justify-center">
                                            <button className="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2" className="w-6 h-6">
                                                    <path strokeLinecap="round" strokeLinejoin="round" d="M15 12h6m0 0v6m0-6v-6m0 6h-6m0 0L9 9l-3 3-6-6" />
                                                </svg>
                                            </button>
