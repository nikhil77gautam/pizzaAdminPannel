        ...
        <div className="h-screen w-64 bg-gray-800 text-white flex flex-col">
            ...
            <nav className="flex-1 p-4">
                <ul className="space-y-4">
                    <li>
                        <Link to="/" className="flex items-center space-x-2 hover:bg-gray-700 p-2 rounded" onClick={toggleSidebar}>
                    ...
                    <li>
                        <div className="cursor-pointer flex items-center justify-between p-2 rounded hover:bg-gray-700" onClick={togglePizzaManagement}>
                        ...
                        {pizzaOpen && (
                            <ul className="pl-6 space-y-2">
                                <li>
                                    <Link to="/admin/addpizza" className="flex items-center space-x-2 hover:bg-gray-700 p-2 rounded" onClick={toggleSidebar}>
                                        <FaPlus className='hover:text-gray-400' />
                                        <span className='hover:text-gray-400'>Add Pizza</span>
                                    </Link>
                                </li>
                                <li onClick={togglePizzaManagement}>
                                    <Link to="/admin/home" className="flex items-center space-x-2 hover:bg-gray-700 p-2 rounded" onClick={toggleSidebar}>
                    ...
                    <li>
                        <div className="cursor-pointer flex items-center justify-between p-2 rounded hover:bg-gray-700" onClick={toggleMealsManagement}>
                            <span className="flex items-center space-x-2">
                                <FaPizzaSlice className='hover:text-gray-400' />
                        ...
                        {mealsOpen && (
                            <ul className="pl-6 space-y-2">
                                <li>
                                    <Link to="/admin/AddMeal" className="flex items-center space-x-2 hover:bg-gray-700 p-2 rounded" onClick={toggleSidebar}>
                                        <FaPlus className='hover:text-gray-400' />
                                        <span className='hover:text-gray-400'>Add Meal</span>
                                    </Link>
                                </li>
                                <li>
                                    <Link to="/admin/MealsList" className="flex items-center space-x-2 hover:bg-gray-700 p-2 rounded " onClick={toggleSidebar}>
                                        <FaClipboardList className='hover:text-gray-400'/>
                    ...
                    <li>
                        <div className="cursor-pointer flex items-center justify-between p-2 rounded hover:bg-gray-700" onClick={toggleRatingManagement}>
                            <span className="flex items-center space-x-2">
                        ...
                        {ratingOpen && (
                            <ul className="pl-6 space-y-2">
                                <li>
                                    <Link to="/admin/ReviewsPage" className="flex items-center space-x-2 hover:bg-gray-700 p-2 rounded" onClick={toggleSidebar}>
                                        <FaClipboardList className='hover:text-gray-400'/>
                    ...
                    {/* Other Sections */}
                    <li>
                        <Link to="/admin/OrdersPage" className="flex items-center space-x-2 hover:bg-gray-700 p-2 rounded" onClick={toggleSidebar}>
                            <FaListAlt className='hover:text-gray-400'/>
                            <span className='hover:text-gray-400'>Manage Orders</span>
                        </Link>
                    </li>
                    <li>
                        <Link to="/admin/manageexpenses" className="flex items-center space-x-2 hover:bg-gray-700 p-2 rounded" onClick={toggleSidebar}>
