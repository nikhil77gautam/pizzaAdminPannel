...
const AdminPanel = () => {
    ...
    return (
        <div className="flex h-screen">
            {/* Navbar */}
            <div className="fixed top-0 left-0 w-full bg-white shadow-md z-30"> {/* Navbar upar hona chahiye */}
                <Navbar toggleSidebar={toggleSidebar} />
            </div>

            {/* Sidebar */}
            <div className={`fixed top-16 left-0 h-full bg-gray-800 text-white transition-transform transform ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0 w-64 z-20`}> 
            ...
            <div className="flex-1 flex flex-col lg:ml-64">
                ...
                <div className="flex-1 mt-16 p-6 overflow-auto bg-gray-100">
                    <Routes>
                        ...
                        <Route path="/admin/Updatepizza/:pizzaId" element={<Updatepizza />} />
